...
#else
    uint32_t r;
    __asm__ volatile("mul_ul_ul %[rc_wr32], %[ra_r32], %[rb_wr32]"
                     : [ rc_wr32 ] "=r"(r)
                     : [ ra_r32 ] "r"(a), [ rb_wr32 ] "r"(b)
                     :);
    return r;
#endif
}
...
#else
    uint32_t r;
    __asm__ volatile("mul_ul_uh %[rc_wr32], %[ra_r32], %[rb_wr32]"
                     : [ rc_wr32 ] "=r"(r)
                     : [ ra_r32 ] "r"(a), [ rb_wr32 ] "r"(b)
                     :);
    return r;
...
#else
    uint32_t r;
    __asm__ volatile("mul_uh_uh %[rc_wr32], %[ra_r32], %[rb_wr32]"
                     : [ rc_wr32 ] "=r"(r)
                     : [ ra_r32 ] "r"(a), [ rb_wr32 ] "r"(b)
                     :);
    return r;
...
#else
    uint32_t r = (b >> 16);
    __asm__ volatile("mul_uh_ul %[rc_wr32], %[ra_r32], %[rb_wr32]"
                     : [ rc_wr32 ] "=r"(r)
                     : [ ra_r32 ] "r"(a), [ rb_wr32 ] "r"(r)
                     :);
    return r;
#endif
}
