...
{
    if (this_vc == NULL) {
        this_vc = get_verbose_control_for("commands");
    }
    return this_vc;
}
#define CI_FRAME_DPU_OPERATION_EMPTY                                                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_EMPTY;\n");                                                                   \
        ((0x0000000000000000L));                                                                                                 \
    })
#define CI_FRAME_DPU_OPERATION_BIT_ORDER(ne, stutter, c2d, d2c)                                                                  \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_BIT_ORDER(ne = %u, stutter = %u, c2d = %u, d2c = %u);\n",                              \
            ne,                                                                                                                  \
            stutter,                                                                                                             \
            c2d,                                                                                                                 \
            d2c);                                                                                                                \
...
#define CI_FRAME_DPU_OPERATION_IDENTITY                                                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IDENTITY;\n");                                                                \
        ((0x01FF000000000000L));                                                                                                 \
    })
#define CI_FRAME_DPU_OPERATION_SOFTWARE_RESET(factor, cycle_accurate)                                                            \
    ({                                                                                                                           \
        LOGV(                                                                                                                    \
            __vc(), "ptr = CI_FRAME_DPU_OPERATION_SOFTWARE_RESET(factor = %u, cycle_accurate = %u);\n", factor, cycle_accurate); \
        ((0x01FF00000000FF00L) | ((uint64_t)(factor) << 0) | ((uint64_t)(cycle_accurate) << 4));                                 \
    })
#define CI_FRAME_DPU_OPERATION_THERMAL_CONFIG(threshold)                                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THERMAL_CONFIG(threshold = %u);\n", threshold);                               \
        ((0x01FF000000FF0000L) | ((uint64_t)(threshold) << 0));                                                                  \
    })
#define CI_FRAME_DPU_OPERATION_CMD_DURATION_FUTUR(duration)                                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_CMD_DURATION_FUTUR(duration = %u);\n", duration);                             \
        ((0x01FF000000FFFF00L) | ((uint64_t)(duration) << 0));                                                                   \
    })
#define CI_FRAME_DPU_OPERATION_RES_DURATION_FUTUR(duration)                                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_RES_DURATION_FUTUR(duration = %u);\n", duration);                             \
        ((0x01FF0000FF000000L) | ((uint64_t)(duration) << 0));                                                                   \
    })
#define CI_FRAME_DPU_OPERATION_RES_SAMPLING_FUTUR(sampling)                                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_RES_SAMPLING_FUTUR(sampling = %u);\n", sampling);                             \
        ((0x01FF0000FF00FF00L) | ((uint64_t)(sampling) << 0));                                                                   \
    })
#define CI_FRAME_DPU_OPERATION_BYTE_ORDER                                                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BYTE_ORDER;\n");                                                              \
        ((0x7777777777777777L));                                                                                                 \
    })
#define CI_FRAME_DPU_OPERATION_NOP                                                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOP;\n");                                                                     \
        ((0xFF00000000000000L));                                                                                                 \
    })
#define CI_FRAME_DPU_OPERATION_SELECT_DPU_STRUCTURE                                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_SELECT_DPU_STRUCTURE;\n");                                                    \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_SELECT_DPU_FRAME(dpu_id)                                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_SELECT_DPU_FRAME(dpu_id = %u);\n", dpu_id);                                   \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(255) << 16)                     \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_SELECT_GROUP_STRUCTURE                                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_SELECT_GROUP_STRUCTURE;\n");                                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_SELECT_GROUP_FRAME(group_id)                                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_SELECT_GROUP_FRAME(group_id = %u);\n", group_id);                             \
        ((0x3300000000000000L) | ((uint64_t)(9) << 0) | ((uint64_t)(group_id) << 8) | ((uint64_t)(255) << 16)                    \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_SELECT_ALL_STRUCTURE                                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_SELECT_ALL_STRUCTURE;\n");                                                    \
...
#define CI_FRAME_DPU_OPERATION_SELECT_ALL_FRAME                                                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_SELECT_ALL_FRAME;\n");                                                        \
...
#define CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_DPU_STRUCTURE                                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_DPU_STRUCTURE;\n");                                           \
        ((0x1100000000000000L) | ((uint64_t)(0b1010) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_ALL_STRUCTURE                                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_ALL_STRUCTURE;\n");                                           \
        ((0x1100000000000000L) | ((uint64_t)(0b100) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                       \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_PREVIOUS_STRUCTURE                                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_PREVIOUS_STRUCTURE;\n");                                      \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_DPU_FRAME(dpu_id, group_id)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_DPU_FRAME(dpu_id = %u, group_id = %u);\n", dpu_id, group_id); \
...
#define CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_ALL_FRAME(group_id)                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_ALL_FRAME(group_id = %u);\n", group_id);                      \
...
#define CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_PREVIOUS_FRAME(group_id)                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_WRITE_GROUP_FOR_PREVIOUS_FRAME(group_id = %u);\n", group_id);                 \
...
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_READ_FOR_DPU_STRUCTURE                                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_READ_FOR_DPU_STRUCTURE;\n");                                         \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_READ_FOR_PREVIOUS_STRUCTURE                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_READ_FOR_PREVIOUS_STRUCTURE;\n");                                    \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_READ_FOR_DPU_FRAME(dpu_id)                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                        \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(16) << 16)                      \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_READ_FOR_PREVIOUS_FRAME                                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_READ_FOR_PREVIOUS_FRAME;\n");                                        \
...
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_DPU_STRUCTURE(byte5)                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_DPU_STRUCTURE(byte5 = %u);\n", byte5);                     \
...
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_GROUP_STRUCTURE(byte5)                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_GROUP_STRUCTURE(byte5 = %u);\n", byte5);                   \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(byte5) << 16)              \
            | ((uint64_t)(167) << 24) | ((uint64_t)(255) << 32) | ((uint64_t)(2) << 40));                                        \
    })
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_ALL_STRUCTURE                                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_ALL_STRUCTURE;\n");                                        \
...
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_PREVIOUS_STRUCTURE                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_PREVIOUS_STRUCTURE;\n");                                   \
...
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_DPU_FRAME(dpu_id, byte0, byte1, byte2, byte3, byte4)                           \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_DPU_FRAME(dpu_id = %u, byte0 = %u, byte1 = %u, byte2 = %u, byte3 "  \
            "= %u, byte4 = %u);\n",                                                                                              \
            dpu_id,                                                                                                              \
            byte0,                                                                                                               \
            byte1,                                                                                                               \
...
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_GROUP_FRAME(group_id, byte0, byte1, byte2, byte3, byte4)                       \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_GROUP_FRAME(group_id = %u, byte0 = %u, byte1 = %u, byte2 = %u, "    \
            "byte3 = %u, byte4 = %u);\n",                                                                                        \
            group_id,                                                                                                            \
            byte0,                                                                                                               \
            byte1,                                                                                                               \
...
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_ALL_FRAME(byte0, byte1, byte2, byte3, byte4, byte5)                            \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_ALL_FRAME(byte0 = %u, byte1 = %u, byte2 = %u, byte3 = %u, byte4 = " \
            "%u, byte5 = %u);\n",                                                                                                \
            byte0,                                                                                                               \
            byte1,                                                                                                               \
            byte2,                                                                                                               \
...
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_PREVIOUS_FRAME(byte0, byte1, byte2, byte3, byte4, byte5)                       \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_WRITE_FOR_PREVIOUS_FRAME(byte0 = %u, byte1 = %u, byte2 = %u, byte3 = %u, "    \
            "byte4 = %u, byte5 = %u);\n",                                                                                        \
            byte0,                                                                                                               \
            byte1,                                                                                                               \
            byte2,                                                                                                               \
...
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_CLEAR_FOR_PREVIOUS_STRUCTURE                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_CLEAR_FOR_PREVIOUS_STRUCTURE;\n");                                   \
        ((0x1100000000000000L) | ((uint64_t)(0b111111) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(255) << 16)                  \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DMA_CTRL_CLEAR_FOR_PREVIOUS_FRAME                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_CTRL_CLEAR_FOR_PREVIOUS_FRAME;\n");                                       \
...
#define CI_FRAME_DPU_OPERATION_DMA_FAULT_THREAD_INDEX_READ_FOR_DPU_STRUCTURE                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_FAULT_THREAD_INDEX_READ_FOR_DPU_STRUCTURE;\n");                           \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DMA_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_STRUCTURE                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_STRUCTURE;\n");                      \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DMA_FAULT_THREAD_INDEX_READ_FOR_DPU_FRAME(dpu_id)                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_FAULT_THREAD_INDEX_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);          \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(17) << 16)                      \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_DMA_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_FRAME                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_FRAME;\n");                          \
...
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_THREAD_INDEX_READ_FOR_DPU_STRUCTURE                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_THREAD_INDEX_READ_FOR_DPU_STRUCTURE;\n");                           \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_STRUCTURE                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_STRUCTURE;\n");                      \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_THREAD_INDEX_READ_FOR_DPU_FRAME(dpu_id)                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_THREAD_INDEX_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);          \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(18) << 16)                      \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_FRAME                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_FRAME;\n");                          \
...
#define CI_FRAME_DPU_OPERATION_MEM_FAULT_THREAD_INDEX_READ_FOR_DPU_STRUCTURE                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_MEM_FAULT_THREAD_INDEX_READ_FOR_DPU_STRUCTURE;\n");                           \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_MEM_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_STRUCTURE                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_MEM_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_STRUCTURE;\n");                      \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_MEM_FAULT_THREAD_INDEX_READ_FOR_DPU_FRAME(dpu_id)                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_MEM_FAULT_THREAD_INDEX_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);          \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(19) << 16)                      \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_MEM_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_FRAME                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_MEM_FAULT_THREAD_INDEX_READ_FOR_PREVIOUS_FRAME;\n");                          \
...
#define CI_FRAME_DPU_OPERATION_PC_LSB_READ_FOR_DPU_STRUCTURE                                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_LSB_READ_FOR_DPU_STRUCTURE;\n");                                           \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_PC_LSB_READ_FOR_PREVIOUS_STRUCTURE                                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_LSB_READ_FOR_PREVIOUS_STRUCTURE;\n");                                      \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_PC_LSB_READ_FOR_DPU_FRAME(dpu_id)                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_LSB_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                          \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(20) << 16)                      \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_PC_LSB_READ_FOR_PREVIOUS_FRAME                                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_LSB_READ_FOR_PREVIOUS_FRAME;\n");                                          \
...
#define CI_FRAME_DPU_OPERATION_PC_MSB_READ_FOR_DPU_STRUCTURE                                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MSB_READ_FOR_DPU_STRUCTURE;\n");                                           \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_PC_MSB_READ_FOR_PREVIOUS_STRUCTURE                                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MSB_READ_FOR_PREVIOUS_STRUCTURE;\n");                                      \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_PC_MSB_READ_FOR_DPU_FRAME(dpu_id)                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MSB_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                          \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(21) << 16)                      \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_PC_MSB_READ_FOR_PREVIOUS_FRAME                                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MSB_READ_FOR_PREVIOUS_FRAME;\n");                                          \
...
#define CI_FRAME_DPU_OPERATION_PC_MODE_READ_FOR_DPU_STRUCTURE                                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_READ_FOR_DPU_STRUCTURE;\n");                                          \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_PC_MODE_READ_FOR_PREVIOUS_STRUCTURE                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_READ_FOR_PREVIOUS_STRUCTURE;\n");                                     \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_PC_MODE_READ_FOR_DPU_FRAME(dpu_id)                                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                         \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(22) << 16)                      \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_PC_MODE_READ_FOR_PREVIOUS_FRAME                                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_READ_FOR_PREVIOUS_FRAME;\n");                                         \
...
#define CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_DPU_STRUCTURE                                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_DPU_STRUCTURE;\n");                                         \
...
#define CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_GROUP_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_GROUP_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b10) << 8) | ((uint64_t)(0) << 16)                 \
            | ((uint64_t)(164) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(255) << 40));                                        \
    })
#define CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_ALL_STRUCTURE                                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_ALL_STRUCTURE;\n");                                         \
...
#define CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_PREVIOUS_STRUCTURE                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_PREVIOUS_STRUCTURE;\n");                                    \
...
#define CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_DPU_FRAME(dpu_id, pc_mode)                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_DPU_FRAME(dpu_id = %u, pc_mode = %u);\n", dpu_id, pc_mode); \
...
#define CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_GROUP_FRAME(group_id, pc_mode)                                                  \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_GROUP_FRAME(group_id = %u, pc_mode = %u);\n",                        \
            group_id,                                                                                                            \
            pc_mode);                                                                                                            \
...
#define CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_ALL_FRAME(pc_mode)                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_ALL_FRAME(pc_mode = %u);\n", pc_mode);                      \
        ((0x3300000000000000L) | ((uint64_t)(8) << 0) | ((uint64_t)(pc_mode) << 8) | ((uint64_t)(0) << 16)                       \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_PREVIOUS_FRAME(pc_mode)                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_PC_MODE_WRITE_FOR_PREVIOUS_FRAME(pc_mode = %u);\n", pc_mode);                 \
        ((0x3300000000000000L) | ((uint64_t)(pc_mode) << 0) | ((uint64_t)(0) << 8) | ((uint64_t)(0) << 16)                       \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(164) << 48));                  \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_DPU_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_DPU_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_GROUP_STRUCTURE                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_GROUP_STRUCTURE;\n");                                \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_ALL_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_ALL_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_PREVIOUS_STRUCTURE                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_PREVIOUS_STRUCTURE;\n");                             \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_DPU_FRAME(dpu_id)                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                 \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(128) << 16)                     \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_GROUP_FRAME(group_id)                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_GROUP_FRAME(group_id = %u);\n", group_id);           \
...
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_ALL_FRAME                                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_ALL_FRAME;\n");                                      \
...
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_PREVIOUS_FRAME                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_READ_FOR_PREVIOUS_FRAME;\n");                                 \
...
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_DPU_STRUCTURE                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_DPU_STRUCTURE;\n");                                   \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_ALL_STRUCTURE                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_ALL_STRUCTURE;\n");                                   \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_PREVIOUS_STRUCTURE                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_PREVIOUS_STRUCTURE;\n");                              \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_DPU_FRAME(dpu_id)                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                  \
...
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_ALL_FRAME                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_ALL_FRAME;\n");                                       \
...
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_PREVIOUS_FRAME                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_CLR_FOR_PREVIOUS_FRAME;\n");                                  \
...
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_DPU_STRUCTURE                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_DPU_STRUCTURE;\n");                          \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_GROUP_STRUCTURE                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_GROUP_STRUCTURE;\n");                        \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_ALL_STRUCTURE                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_ALL_STRUCTURE;\n");                          \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_PREVIOUS_STRUCTURE                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_PREVIOUS_STRUCTURE;\n");                     \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_DPU_FRAME(dpu_id)                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);         \
...
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_GROUP_FRAME(group_id)                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_GROUP_FRAME(group_id = %u);\n", group_id);   \
...
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_ALL_FRAME                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_ALL_FRAME;\n");                              \
...
#define CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_PREVIOUS_FRAME                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_FAULT_STATE_SET_AND_STEP_FOR_PREVIOUS_FRAME;\n");                         \
...
#define CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_DPU_STRUCTURE                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_DPU_STRUCTURE;\n");                                    \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_GROUP_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_GROUP_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_ALL_STRUCTURE                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_ALL_STRUCTURE;\n");                                    \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_PREVIOUS_STRUCTURE                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_PREVIOUS_STRUCTURE;\n");                               \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_DPU_FRAME(dpu_id)                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                   \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(132) << 16)                     \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_GROUP_FRAME(group_id)                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_GROUP_FRAME(group_id = %u);\n", group_id);             \
...
#define CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_ALL_FRAME                                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_ALL_FRAME;\n");                                        \
...
#define CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_PREVIOUS_FRAME                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DPU_RUN_STATE_READ_FOR_PREVIOUS_FRAME;\n");                                   \
...
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_DPU_STRUCTURE                                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_DPU_STRUCTURE;\n");                                        \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_ALL_STRUCTURE                                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_ALL_STRUCTURE;\n");                                        \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_PREVIOUS_STRUCTURE                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_PREVIOUS_STRUCTURE;\n");                                   \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_DPU_FRAME(dpu_id)                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                       \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(176) << 16)                     \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_ALL_FRAME                                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_ALL_FRAME;\n");                                            \
...
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_PREVIOUS_FRAME                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_READ_FOR_PREVIOUS_FRAME;\n");                                       \
...
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_DPU_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_DPU_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_ALL_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_ALL_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_PREVIOUS_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_PREVIOUS_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_DPU_FRAME(dpu_id)                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                      \
...
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_ALL_FRAME                                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_ALL_FRAME;\n");                                           \
...
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_PREVIOUS_FRAME                                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_CLEAR_FOR_PREVIOUS_FRAME;\n");                                      \
...
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_SET_FOR_DPU_STRUCTURE                                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_SET_FOR_DPU_STRUCTURE;\n");                                         \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_SET_FOR_PREVIOUS_STRUCTURE                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_SET_FOR_PREVIOUS_STRUCTURE;\n");                                    \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_SET_FOR_DPU_FRAME(dpu_id)                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_SET_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                        \
...
#define CI_FRAME_DPU_OPERATION_BKP_FAULT_SET_FOR_PREVIOUS_FRAME                                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_BKP_FAULT_SET_FOR_PREVIOUS_FRAME;\n");                                        \
...
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_READ_FOR_DPU_STRUCTURE                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_READ_FOR_DPU_STRUCTURE;\n");                                     \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_READ_FOR_PREVIOUS_STRUCTURE                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_READ_FOR_PREVIOUS_STRUCTURE;\n");                                \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_READ_FOR_DPU_FRAME(dpu_id)                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_READ_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                    \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(180) << 16)                     \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_READ_FOR_PREVIOUS_FRAME                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_READ_FOR_PREVIOUS_FRAME;\n");                                    \
...
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_DPU_STRUCTURE                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_DPU_STRUCTURE;\n");                                    \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_ALL_STRUCTURE                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_ALL_STRUCTURE;\n");                                    \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_PREVIOUS_STRUCTURE                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_PREVIOUS_STRUCTURE;\n");                               \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_DPU_FRAME(dpu_id)                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                   \
...
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_ALL_FRAME                                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_ALL_FRAME;\n");                                        \
...
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_PREVIOUS_FRAME                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_CLEAR_FOR_PREVIOUS_FRAME;\n");                                   \
...
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_SET_FOR_DPU_STRUCTURE                                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_SET_FOR_DPU_STRUCTURE;\n");                                      \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_SET_FOR_PREVIOUS_STRUCTURE                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_SET_FOR_PREVIOUS_STRUCTURE;\n");                                 \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_SET_FOR_DPU_FRAME(dpu_id)                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_SET_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                     \
...
#define CI_FRAME_DPU_OPERATION_POISON_FAULT_SET_FOR_PREVIOUS_FRAME                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_POISON_FAULT_SET_FOR_PREVIOUS_FRAME;\n");                                     \
...
#define CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_DPU_STRUCTURE                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_DPU_STRUCTURE;\n");                                \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_ALL_STRUCTURE                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_ALL_STRUCTURE;\n");                                \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_PREVIOUS_STRUCTURE                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_PREVIOUS_STRUCTURE;\n");                           \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_DPU_FRAME(dpu_id)                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);               \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(130) << 16)                     \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_ALL_FRAME                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_ALL_FRAME;\n");                                    \
...
#define CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_PREVIOUS_FRAME                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DMA_FAULT_READ_AND_CLR_FOR_PREVIOUS_FRAME;\n");                               \
...
#define CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_DPU_STRUCTURE                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_DPU_STRUCTURE;\n");                                \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_ALL_STRUCTURE                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_ALL_STRUCTURE;\n");                                \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_PREVIOUS_STRUCTURE                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_PREVIOUS_STRUCTURE;\n");                           \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_DPU_FRAME(dpu_id)                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);               \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(244) << 16)                     \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_ALL_FRAME                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_ALL_FRAME;\n");                                    \
...
#define CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_PREVIOUS_FRAME                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_MEM_FAULT_READ_AND_CLR_FOR_PREVIOUS_FRAME;\n");                               \
...
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_DPU_STRUCTURE                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_DPU_STRUCTURE;\n");                                 \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_GROUP_STRUCTURE                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_GROUP_STRUCTURE;\n");                               \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_ALL_STRUCTURE                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_ALL_STRUCTURE;\n");                                 \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_PREVIOUS_STRUCTURE                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_PREVIOUS_STRUCTURE;\n");                            \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_DPU_FRAME(dpu_id)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(240) << 16)                     \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_GROUP_FRAME(group_id)                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_GROUP_FRAME(group_id = %u);\n", group_id);          \
...
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_ALL_FRAME                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_ALL_FRAME;\n");                                     \
...
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_PREVIOUS_FRAME                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_CLR_FOR_PREVIOUS_FRAME;\n");                                \
...
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_DPU_STRUCTURE                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_DPU_STRUCTURE;\n");                                 \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_GROUP_STRUCTURE                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_GROUP_STRUCTURE;\n");                               \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_ALL_STRUCTURE                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_ALL_STRUCTURE;\n");                                 \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_PREVIOUS_STRUCTURE                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_PREVIOUS_STRUCTURE;\n");                            \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_DPU_FRAME(dpu_id)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);                \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(242) << 16)                     \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_GROUP_FRAME(group_id)                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_GROUP_FRAME(group_id = %u);\n", group_id);          \
...
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_ALL_FRAME                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_ALL_FRAME;\n");                                     \
...
#define CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_PREVIOUS_FRAME                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_STACK_UP_READ_AND_SET_FOR_PREVIOUS_FRAME;\n");                                \
...
#define CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_DPU_STRUCTURE(thread_id)                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_DPU_STRUCTURE(thread_id = %u);\n", thread_id);                \
...
#define CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_GROUP_STRUCTURE(thread_id)                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_GROUP_STRUCTURE(thread_id = %u);\n", thread_id);              \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)(((((138002131058688l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_ALL_STRUCTURE                                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_ALL_STRUCTURE;\n");                                           \
...
#define CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_PREVIOUS_STRUCTURE                                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_PREVIOUS_STRUCTURE;\n");                                      \
...
#define CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_DPU_FRAME(dpu_id, thread_id)                                                      \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_DPU_FRAME(dpu_id = %u, thread_id = %u);\n",                            \
            dpu_id,                                                                                                              \
            thread_id);                                                                                                          \
...
#define CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_GROUP_FRAME(group_id, thread_id)                                                  \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_GROUP_FRAME(group_id = %u, thread_id = %u);\n",                        \
            group_id,                                                                                                            \
            thread_id);                                                                                                          \
...
#define CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_ALL_FRAME(thread_id)                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_ALL_FRAME(thread_id = %u);\n", thread_id);                    \
...
#define CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_PREVIOUS_FRAME(thread_id)                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_BOOT_FOR_PREVIOUS_FRAME(thread_id = %u);\n", thread_id);               \
        ((0x3300000000000000L)                                                                                                   \
            | ((uint64_t)(((((138002131058688l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_DPU_STRUCTURE(thread_id)                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_DPU_STRUCTURE(thread_id = %u);\n", thread_id);              \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
...
#define CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_GROUP_STRUCTURE(thread_id)                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_GROUP_STRUCTURE(thread_id = %u);\n", thread_id);            \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)(((((137452375244800l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_ALL_STRUCTURE                                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_ALL_STRUCTURE;\n");                                         \
        ((0x1100000000000000L) | ((uint64_t)(0b1111110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(152) << 16)                 \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_PREVIOUS_STRUCTURE                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_PREVIOUS_STRUCTURE;\n");                                    \
        ((0x1100000000000000L) | ((uint64_t)(0b111111) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(2) << 16)                    \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_DPU_FRAME(dpu_id, thread_id)                                                    \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_DPU_FRAME(dpu_id = %u, thread_id = %u);\n",                          \
            dpu_id,                                                                                                              \
            thread_id);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)(((((137452375244800l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
...
#define CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_GROUP_FRAME(group_id, thread_id)                                                \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_GROUP_FRAME(group_id = %u, thread_id = %u);\n",                      \
            group_id,                                                                                                            \
            thread_id);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(9) << 0) | ((uint64_t)(group_id) << 8)                                              \
            | ((uint64_t)(((((137452375244800l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
...
#define CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_ALL_FRAME(thread_id)                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_ALL_FRAME(thread_id = %u);\n", thread_id);                  \
        ((0x3300000000000000L) | ((uint64_t)(8) << 0)                                                                            \
            | ((uint64_t)(((((137452375244800l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_PREVIOUS_FRAME(thread_id)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_RESUME_FOR_PREVIOUS_FRAME(thread_id = %u);\n", thread_id);             \
        ((0x3300000000000000L)                                                                                                   \
            | ((uint64_t)(((((137452375244800l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_DPU_STRUCTURE(thread_id)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_DPU_STRUCTURE(thread_id = %u);\n", thread_id);             \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
...
#define CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_GROUP_STRUCTURE(thread_id)                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_GROUP_STRUCTURE(thread_id = %u);\n", thread_id);           \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_ALL_STRUCTURE                                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_ALL_STRUCTURE;\n");                                        \
        ((0x1100000000000000L) | ((uint64_t)(0b1111110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(152) << 16)                 \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_PREVIOUS_STRUCTURE                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_PREVIOUS_STRUCTURE;\n");                                   \
        ((0x1100000000000000L) | ((uint64_t)(0b111111) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(2) << 16)                    \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_DPU_FRAME(dpu_id, thread_id)                                                   \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_DPU_FRAME(dpu_id = %u, thread_id = %u);\n",                         \
            dpu_id,                                                                                                              \
            thread_id);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
...
#define CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_GROUP_FRAME(group_id, thread_id)                                               \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_GROUP_FRAME(group_id = %u, thread_id = %u);\n",                     \
            group_id,                                                                                                            \
            thread_id);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(9) << 0) | ((uint64_t)(group_id) << 8)                                              \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
...
#define CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_ALL_FRAME(thread_id)                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_ALL_FRAME(thread_id = %u);\n", thread_id);                 \
        ((0x3300000000000000L) | ((uint64_t)(8) << 0)                                                                            \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_PREVIOUS_FRAME(thread_id)                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_CLR_RUN_FOR_PREVIOUS_FRAME(thread_id = %u);\n", thread_id);            \
        ((0x3300000000000000L)                                                                                                   \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_DPU_STRUCTURE(thread_id)                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_DPU_STRUCTURE(thread_id = %u);\n", thread_id);            \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
...
#define CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_GROUP_STRUCTURE(thread_id)                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_GROUP_STRUCTURE(thread_id = %u);\n", thread_id);          \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_ALL_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_ALL_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b1111110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(152) << 16)                 \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_PREVIOUS_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_PREVIOUS_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b111111) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(2) << 16)                    \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_DPU_FRAME(dpu_id, thread_id)                                                  \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_DPU_FRAME(dpu_id = %u, thread_id = %u);\n",                        \
            dpu_id,                                                                                                              \
            thread_id);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
...
#define CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_GROUP_FRAME(group_id, thread_id)                                              \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_GROUP_FRAME(group_id = %u, thread_id = %u);\n",                    \
            group_id,                                                                                                            \
            thread_id);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(9) << 0) | ((uint64_t)(group_id) << 8)                                              \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
...
#define CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_ALL_FRAME(thread_id)                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_ALL_FRAME(thread_id = %u);\n", thread_id);                \
        ((0x3300000000000000L) | ((uint64_t)(8) << 0)                                                                            \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_PREVIOUS_FRAME(thread_id)                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_THREAD_READ_RUN_FOR_PREVIOUS_FRAME(thread_id = %u);\n", thread_id);           \
        ((0x3300000000000000L)                                                                                                   \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_DPU_STRUCTURE(data, address)                                           \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_DPU_STRUCTURE(data = %lu, address = %u);\n",                \
            data,                                                                                                                \
            address);                                                                                                            \
...
#define CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_GROUP_STRUCTURE(data, address)                                         \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_GROUP_STRUCTURE(data = %lu, address = %u);\n",              \
            data,                                                                                                                \
            address);                                                                                                            \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b11) << 8)                                         \
            | ((uint64_t)((((data) >> (((5) << 3))) & 0xFFl)) << 16) | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 24) \
...
#define CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_ALL_STRUCTURE(address)                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_ALL_STRUCTURE(address = %u);\n", address);         \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b1) << 8)                                          \
            | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 16)                                                          \
            | ((uint64_t)((((address) >> (((1) << 3))) & 0xFFl)) << 24) | ((uint64_t)(71) << 32) | ((uint64_t)(2) << 40));       \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_PREVIOUS_STRUCTURE(address)                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_PREVIOUS_STRUCTURE(address = %u);\n", address);    \
...
#define CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_DPU_FRAME(dpu_id, data)                                                \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_DPU_FRAME(dpu_id = %u, data = %lu);\n",                     \
            dpu_id,                                                                                                              \
            data);                                                                                                               \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
...
#define CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_GROUP_FRAME(group_id, data)                                            \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_GROUP_FRAME(group_id = %u, data = %lu);\n",                 \
            group_id,                                                                                                            \
            data);                                                                                                               \
        ((0x3300000000000000L) | ((uint64_t)(9) << 0) | ((uint64_t)(group_id) << 8)                                              \
            | ((uint64_t)((((data) >> (((0) << 3))) & 0xFFl)) << 16) | ((uint64_t)((((data) >> (((1) << 3))) & 0xFFl)) << 24)    \
...
#define CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_ALL_FRAME(data)                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_ALL_FRAME(data = %lu);\n", data);                  \
...
#define CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_PREVIOUS_FRAME(data, address)                                          \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_WRITE_INSTRUCTION_FOR_PREVIOUS_FRAME(data = %lu, address = %u);\n",               \
            data,                                                                                                                \
            address);                                                                                                            \
        ((0x3300000000000000L) | ((uint64_t)((((data) >> (((0) << 3))) & 0xFFl)) << 0)                                           \
            ...
            | ((uint64_t)((((data) >> (((5) << 3))) & 0xFFl)) << 40)                                                             \
            | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 48));                                                        \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE0_FOR_DPU_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE0_FOR_DPU_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b1110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE0_FOR_PREVIOUS_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE0_FOR_PREVIOUS_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b11) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE0_FOR_DPU_FRAME(dpu_id, address)                                                    \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE0_FOR_DPU_FRAME(dpu_id = %u, address = %u);\n",                          \
            dpu_id,                                                                                                              \
            address);                                                                                                            \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 16)                                                          \
            | ((uint64_t)((((address) >> (((1) << 3))) & 0xFFl)) << 24) | ((uint64_t)(64) << 32) | ((uint64_t)(2) << 40)         \
            | ((uint64_t)(0) << 48));                                                                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE0_FOR_PREVIOUS_FRAME(address)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE0_FOR_PREVIOUS_FRAME(address = %u);\n", address);               \
...
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE1_FOR_DPU_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE1_FOR_DPU_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b1110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE1_FOR_PREVIOUS_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE1_FOR_PREVIOUS_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b11) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE1_FOR_DPU_FRAME(dpu_id, address)                                                    \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE1_FOR_DPU_FRAME(dpu_id = %u, address = %u);\n",                          \
            dpu_id,                                                                                                              \
            address);                                                                                                            \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 16)                                                          \
            | ((uint64_t)((((address) >> (((1) << 3))) & 0xFFl)) << 24) | ((uint64_t)(65) << 32) | ((uint64_t)(2) << 40)         \
            | ((uint64_t)(0) << 48));                                                                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE1_FOR_PREVIOUS_FRAME(address)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE1_FOR_PREVIOUS_FRAME(address = %u);\n", address);               \
        ((0x3300000000000000L) | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 0)                                        \
...
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE2_FOR_DPU_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE2_FOR_DPU_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b1110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE2_FOR_PREVIOUS_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE2_FOR_PREVIOUS_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b11) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE2_FOR_DPU_FRAME(dpu_id, address)                                                    \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE2_FOR_DPU_FRAME(dpu_id = %u, address = %u);\n",                          \
            dpu_id,                                                                                                              \
            address);                                                                                                            \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 16)                                                          \
            | ((uint64_t)((((address) >> (((1) << 3))) & 0xFFl)) << 24) | ((uint64_t)(66) << 32) | ((uint64_t)(2) << 40)         \
            | ((uint64_t)(0) << 48));                                                                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE2_FOR_PREVIOUS_FRAME(address)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE2_FOR_PREVIOUS_FRAME(address = %u);\n", address);               \
        ((0x3300000000000000L) | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 0)                                        \
...
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE3_FOR_DPU_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE3_FOR_DPU_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b1110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE3_FOR_PREVIOUS_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE3_FOR_PREVIOUS_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b11) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE3_FOR_DPU_FRAME(dpu_id, address)                                                    \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE3_FOR_DPU_FRAME(dpu_id = %u, address = %u);\n",                          \
            dpu_id,                                                                                                              \
            address);                                                                                                            \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 16)                                                          \
            | ((uint64_t)((((address) >> (((1) << 3))) & 0xFFl)) << 24) | ((uint64_t)(67) << 32) | ((uint64_t)(2) << 40)         \
            | ((uint64_t)(0) << 48));                                                                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE3_FOR_PREVIOUS_FRAME(address)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE3_FOR_PREVIOUS_FRAME(address = %u);\n", address);               \
        ((0x3300000000000000L) | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 0)                                        \
...
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE4_FOR_DPU_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE4_FOR_DPU_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b1110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE4_FOR_PREVIOUS_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE4_FOR_PREVIOUS_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b11) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE4_FOR_DPU_FRAME(dpu_id, address)                                                    \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE4_FOR_DPU_FRAME(dpu_id = %u, address = %u);\n",                          \
            dpu_id,                                                                                                              \
            address);                                                                                                            \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 16)                                                          \
            | ((uint64_t)((((address) >> (((1) << 3))) & 0xFFl)) << 24) | ((uint64_t)(68) << 32) | ((uint64_t)(2) << 40)         \
            | ((uint64_t)(0) << 48));                                                                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE4_FOR_PREVIOUS_FRAME(address)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE4_FOR_PREVIOUS_FRAME(address = %u);\n", address);               \
        ((0x3300000000000000L) | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 0)                                        \
...
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE5_FOR_DPU_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE5_FOR_DPU_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b1110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE5_FOR_PREVIOUS_STRUCTURE                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE5_FOR_PREVIOUS_STRUCTURE;\n");                                  \
        ((0x1100000000000000L) | ((uint64_t)(0b11) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE5_FOR_DPU_FRAME(dpu_id, address)                                                    \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE5_FOR_DPU_FRAME(dpu_id = %u, address = %u);\n",                          \
            dpu_id,                                                                                                              \
            address);                                                                                                            \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 16)                                                          \
            | ((uint64_t)((((address) >> (((1) << 3))) & 0xFFl)) << 24) | ((uint64_t)(69) << 32) | ((uint64_t)(2) << 40)         \
            | ((uint64_t)(0) << 48));                                                                                            \
    })
#define CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE5_FOR_PREVIOUS_FRAME(address)                                                       \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IRAM_READ_BYTE5_FOR_PREVIOUS_FRAME(address = %u);\n", address);               \
        ((0x3300000000000000L) | ((uint64_t)((((address) >> (((0) << 3))) & 0xFFl)) << 0)                                        \
...
#define CI_FRAME_DPU_OPERATION_WRAM_WRITE_WORD_FOR_PREVIOUS_STRUCTURE(address)                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_WRAM_WRITE_WORD_FOR_PREVIOUS_STRUCTURE(address = %u);\n", address);           \
...
#define CI_FRAME_DPU_OPERATION_WRAM_WRITE_WORD_FOR_PREVIOUS_FRAME(data, address)                                                 \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_WRAM_WRITE_WORD_FOR_PREVIOUS_FRAME(data = %u, address = %u);\n",                       \
            data,                                                                                                                \
            address);                                                                                                            \
        ((0x3300000000000000L) | ((uint64_t)((((data) >> (((0) << 3))) & 0xFFl)) << 0)                                           \
            | ((uint64_t)((((data) >> (((1) << 3))) & 0xFFl)) << 8) | ((uint64_t)((((data) >> (((2) << 3))) & 0xFFl)) << 16)     \
...
#define CI_FRAME_DPU_OPERATION_WRAM_READ_WORD_FOR_DPU_STRUCTURE(address)                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_WRAM_READ_WORD_FOR_DPU_STRUCTURE(address = %u);\n", address);                 \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)((                                                                                                      \
                   (((123159328063488l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 1) << 27)               \
                        | (((((uint64_t)((address) << 2)) >> 0) & 15) << 20)                                                     \
                        | (((((uint64_t)((address) << 2)) >> 4) & 15) << 16) | (((((uint64_t)((address) << 2)) >> 8) & 1) << 15) \
                        | (((((uint64_t)((address) << 2)) >> 9) & 1) << 14) | (((((uint64_t)((address) << 2)) >> 10) & 1) << 13) \
                        | (((((uint64_t)((address) << 2)) >> 11) & 1) << 12)                                                     \
...
#define CI_FRAME_DPU_OPERATION_WRAM_READ_WORD_FOR_PREVIOUS_STRUCTURE                                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_WRAM_READ_WORD_FOR_PREVIOUS_STRUCTURE;\n");                                   \
        ((0x1100000000000000L) | ((uint64_t)(0b111111) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(2) << 16)                    \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_WRAM_READ_WORD_FOR_DPU_FRAME(dpu_id, address)                                                     \
    ({                                                                                                                           \
        LOGV(                                                                                                                    \
            __vc(), "ptr = CI_FRAME_DPU_OPERATION_WRAM_READ_WORD_FOR_DPU_FRAME(dpu_id = %u, address = %u);\n", dpu_id, address); \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)((                                                                                                      \
                   (((123159328063488l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 1) << 27)               \
                        | (((((uint64_t)((address) << 2)) >> 0) & 15) << 20)                                                     \
...
#define CI_FRAME_DPU_OPERATION_WRAM_READ_WORD_FOR_PREVIOUS_FRAME(address)                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_WRAM_READ_WORD_FOR_PREVIOUS_FRAME(address = %u);\n", address);                \
        ((0x3300000000000000L)                                                                                                   \
            | ((uint64_t)((                                                                                                      \
                   (((123159328063488l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 1) << 27)               \
                        | (((((uint64_t)((address) << 2)) >> 0) & 15) << 20)                                                     \
...
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_AB_FOR_DPU_STRUCTURE                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_AB_FOR_DPU_STRUCTURE;\n");                                     \
...
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_AB_FOR_PREVIOUS_STRUCTURE                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_AB_FOR_PREVIOUS_STRUCTURE;\n");                                \
        ((0x1100000000000000L) | ((uint64_t)(0b1010) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_AB_FOR_DPU_FRAME(dpu_id, msb, lsb_A, lsb_B)                                        \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_AB_FOR_DPU_FRAME(dpu_id = %u, msb = %u, lsb_A = %u, lsb_B = %u);\n",    \
            dpu_id,                                                                                                              \
            msb,                                                                                                                 \
            lsb_A,                                                                                                               \
            lsb_B);                                                                                                              \
...
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_AB_FOR_PREVIOUS_FRAME(msb, lsb_A, lsb_B)                                           \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_AB_FOR_PREVIOUS_FRAME(msb = %u, lsb_A = %u, lsb_B = %u);\n",            \
            msb,                                                                                                                 \
            lsb_A,                                                                                                               \
            lsb_B);                                                                                                              \
...
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_CD_FOR_DPU_STRUCTURE                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_CD_FOR_DPU_STRUCTURE;\n");                                     \
        ((0x1100000000000000L) | ((uint64_t)(0b101010) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(2) << 16)                    \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_CD_FOR_PREVIOUS_STRUCTURE                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_CD_FOR_PREVIOUS_STRUCTURE;\n");                                \
        ((0x1100000000000000L) | ((uint64_t)(0b1010) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_CD_FOR_DPU_FRAME(dpu_id, msb, lsb_C, lsb_D)                                        \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_CD_FOR_DPU_FRAME(dpu_id = %u, msb = %u, lsb_C = %u, lsb_D = %u);\n",    \
            dpu_id,                                                                                                              \
            msb,                                                                                                                 \
            lsb_C,                                                                                                               \
            lsb_D);                                                                                                              \
...
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_CD_FOR_PREVIOUS_FRAME(msb, lsb_C, lsb_D)                                           \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_CD_FOR_PREVIOUS_FRAME(msb = %u, lsb_C = %u, lsb_D = %u);\n",            \
            msb,                                                                                                                 \
            lsb_C,                                                                                                               \
            lsb_D);                                                                                                              \
...
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_OE_FOR_DPU_STRUCTURE                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_OE_FOR_DPU_STRUCTURE;\n");                                     \
        ((0x1100000000000000L) | ((uint64_t)(0b101010) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(2) << 16)                    \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_OE_FOR_PREVIOUS_STRUCTURE                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_OE_FOR_PREVIOUS_STRUCTURE;\n");                                \
        ((0x1100000000000000L) | ((uint64_t)(0b1010) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_OE_FOR_DPU_FRAME(dpu_id, odd_index, even_index, timing)                            \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_OE_FOR_DPU_FRAME(dpu_id = %u, odd_index = %u, even_index = %u, timing " \
            "= %u);\n",                                                                                                          \
            dpu_id,                                                                                                              \
            odd_index,                                                                                                           \
            even_index,                                                                                                          \
...
#define CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_OE_FOR_PREVIOUS_FRAME(odd_index, even_index, timing)                               \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_IREPAIR_CONFIG_OE_FOR_PREVIOUS_FRAME(odd_index = %u, even_index = %u, timing = "       \
            "%u);\n",                                                                                                            \
            odd_index,                                                                                                           \
            even_index,                                                                                                          \
            timing);                                                                                                             \
...
#define CI_FRAME_DPU_OPERATION_REGISTER_FILE_TIMING_CONFIG_FOR_PREVIOUS_STRUCTURE                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_REGISTER_FILE_TIMING_CONFIG_FOR_PREVIOUS_STRUCTURE;\n");                      \
...
#define CI_FRAME_DPU_OPERATION_REGISTER_FILE_TIMING_CONFIG_FOR_PREVIOUS_FRAME(rf_timing)                                         \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_REGISTER_FILE_TIMING_CONFIG_FOR_PREVIOUS_FRAME(rf_timing = %u);\n",                    \
            rf_timing);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(0) << 0) | ((uint64_t)(rf_timing) << 8) | ((uint64_t)(0) << 16)                     \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_CMD_BUS_CONFIG_DURATION_FOR_PREVIOUS_STRUCTURE                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_CMD_BUS_CONFIG_DURATION_FOR_PREVIOUS_STRUCTURE;\n");                          \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_CMD_BUS_CONFIG_DURATION_FOR_PREVIOUS_FRAME(duration)                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_CMD_BUS_CONFIG_DURATION_FOR_PREVIOUS_FRAME(duration = %u);\n", duration);     \
...
#define CI_FRAME_DPU_OPERATION_CMD_BUS_CONFIG_SAMPLING_FOR_PREVIOUS_STRUCTURE                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_CMD_BUS_CONFIG_SAMPLING_FOR_PREVIOUS_STRUCTURE;\n");                          \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_CMD_BUS_CONFIG_SAMPLING_FOR_PREVIOUS_FRAME(sampling)                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_CMD_BUS_CONFIG_SAMPLING_FOR_PREVIOUS_FRAME(sampling = %u);\n", sampling);     \
...
#define CI_FRAME_DPU_OPERATION_CMD_BUS_SYNC_FOR_PREVIOUS_STRUCTURE                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_CMD_BUS_SYNC_FOR_PREVIOUS_STRUCTURE;\n");                                     \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_CMD_BUS_SYNC_FOR_PREVIOUS_FRAME                                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_CMD_BUS_SYNC_FOR_PREVIOUS_FRAME;\n");                                         \
...
#define CI_FRAME_DPU_OPERATION_RES_BUS_CONFIG_DURATION_FOR_PREVIOUS_STRUCTURE                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_RES_BUS_CONFIG_DURATION_FOR_PREVIOUS_STRUCTURE;\n");                          \
        ((0x1100000000000000L) | ((uint64_t)(0b10111111) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                  \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_RES_BUS_CONFIG_DURATION_FOR_PREVIOUS_FRAME(duration)                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_RES_BUS_CONFIG_DURATION_FOR_PREVIOUS_FRAME(duration = %u);\n", duration);     \
        ((0x3300000000000000L) | ((uint64_t)(duration) << 0) | ((uint64_t)(0) << 8) | ((uint64_t)(0) << 16)                      \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(246) << 48));                  \
    })
#define CI_FRAME_DPU_OPERATION_RES_BUS_SYNC_FOR_PREVIOUS_STRUCTURE                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_RES_BUS_SYNC_FOR_PREVIOUS_STRUCTURE;\n");                                     \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_RES_BUS_SYNC_FOR_PREVIOUS_FRAME                                                                   \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_RES_BUS_SYNC_FOR_PREVIOUS_FRAME;\n");                                         \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_DPU_STRUCTURE(thread_id)                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_DPU_STRUCTURE(thread_id = %u);\n", thread_id);                \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_GROUP_STRUCTURE(thread_id)                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_GROUP_STRUCTURE(thread_id = %u);\n", thread_id);              \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_ALL_STRUCTURE                                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_ALL_STRUCTURE;\n");                                           \
        ((0x1100000000000000L) | ((uint64_t)(0b1111110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(152) << 16)                 \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_PREVIOUS_STRUCTURE                                                                \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_PREVIOUS_STRUCTURE;\n");                                      \
        ((0x1100000000000000L) | ((uint64_t)(0b111111) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(2) << 16)                    \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_DPU_FRAME(dpu_id, thread_id)                                                      \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_DPU_FRAME(dpu_id = %u, thread_id = %u);\n",                            \
            dpu_id,                                                                                                              \
            thread_id);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_GROUP_FRAME(group_id, thread_id)                                                  \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_GROUP_FRAME(group_id = %u, thread_id = %u);\n",                        \
            group_id,                                                                                                            \
            thread_id);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(9) << 0) | ((uint64_t)(group_id) << 8)                                              \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_ALL_FRAME(thread_id)                                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_ALL_FRAME(thread_id = %u);\n", thread_id);                    \
        ((0x3300000000000000L) | ((uint64_t)(8) << 0)                                                                            \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_PREVIOUS_FRAME(thread_id)                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_READ_FOR_PREVIOUS_FRAME(thread_id = %u);\n", thread_id);               \
        ((0x3300000000000000L)                                                                                                   \
            | ((uint64_t)(((((136353132052480l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_DPU_STRUCTURE(thread_id)                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_DPU_STRUCTURE(thread_id = %u);\n", thread_id);                 \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_GROUP_STRUCTURE(thread_id)                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_GROUP_STRUCTURE(thread_id = %u);\n", thread_id);               \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_ALL_STRUCTURE                                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_ALL_STRUCTURE;\n");                                            \
        ((0x1100000000000000L) | ((uint64_t)(0b1111110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(152) << 16)                 \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_PREVIOUS_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_PREVIOUS_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b111111) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(2) << 16)                    \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_DPU_FRAME(dpu_id, thread_id)                                                       \
    ({                                                                                                                           \
        LOGV(                                                                                                                    \
            __vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_DPU_FRAME(dpu_id = %u, thread_id = %u);\n", dpu_id, thread_id); \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_GROUP_FRAME(group_id, thread_id)                                                   \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_GROUP_FRAME(group_id = %u, thread_id = %u);\n",                         \
            group_id,                                                                                                            \
            thread_id);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(9) << 0) | ((uint64_t)(group_id) << 8)                                              \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_ALL_FRAME(thread_id)                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_ALL_FRAME(thread_id = %u);\n", thread_id);                     \
        ((0x3300000000000000L) | ((uint64_t)(8) << 0)                                                                            \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_PREVIOUS_FRAME(thread_id)                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_CLR_FOR_PREVIOUS_FRAME(thread_id = %u);\n", thread_id);                \
        ((0x3300000000000000L)                                                                                                   \
            | ((uint64_t)(((((136902619430912l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_DPU_STRUCTURE(thread_id)                                                           \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_DPU_STRUCTURE(thread_id = %u);\n", thread_id);                 \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)(((((138002131058688l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_GROUP_STRUCTURE(thread_id)                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_GROUP_STRUCTURE(thread_id = %u);\n", thread_id);               \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
            | ((uint64_t)(((((138002131058688l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_ALL_STRUCTURE                                                                      \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_ALL_STRUCTURE;\n");                                            \
        ((0x1100000000000000L) | ((uint64_t)(0b1111110) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(152) << 16)                 \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_PREVIOUS_STRUCTURE                                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_PREVIOUS_STRUCTURE;\n");                                       \
        ((0x1100000000000000L) | ((uint64_t)(0b111111) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(2) << 16)                    \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_DPU_FRAME(dpu_id, thread_id)                                                       \
    ({                                                                                                                           \
        LOGV(                                                                                                                    \
            __vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_DPU_FRAME(dpu_id = %u, thread_id = %u);\n", dpu_id, thread_id); \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)(((((138002131058688l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_GROUP_FRAME(group_id, thread_id)                                                   \
    ({                                                                                                                           \
        LOGV(__vc(),                                                                                                             \
            "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_GROUP_FRAME(group_id = %u, thread_id = %u);\n",                         \
            group_id,                                                                                                            \
            thread_id);                                                                                                          \
        ((0x3300000000000000L) | ((uint64_t)(9) << 0) | ((uint64_t)(group_id) << 8)                                              \
            | ((uint64_t)(((((138002131058688l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_ALL_FRAME(thread_id)                                                               \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_ALL_FRAME(thread_id = %u);\n", thread_id);                     \
        ((0x3300000000000000L) | ((uint64_t)(8) << 0)                                                                            \
            | ((uint64_t)(((((138002131058688l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_PREVIOUS_FRAME(thread_id)                                                          \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_NOTIFY_SET_FOR_PREVIOUS_FRAME(thread_id = %u);\n", thread_id);                \
        ((0x3300000000000000L)                                                                                                   \
            | ((uint64_t)(((((138002131058688l | (((((uint64_t)24) >> 0) & 31) << 34) | (((((uint64_t)0) >> 0) & 15) << 24)      \
                                | (((((uint64_t)(thread_id)) >> 0) & 15) << 20) | (((((uint64_t)(thread_id)) >> 4) & 15) << 16)  \
                                | (((((uint64_t)0) >> 0) & 65535) << 0)))                                                        \
...
#define CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_STOP_ENABLED_FOR_DPU_STRUCTURE                                                  \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_STOP_ENABLED_FOR_DPU_STRUCTURE;\n");                        \
        ((0x1100000000000000L) | ((uint64_t)(0b11111110) << 0) | ((uint64_t)(0b0) << 8)                                          \
...
#define CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_STOP_ENABLED_FOR_PREVIOUS_STRUCTURE                                             \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_STOP_ENABLED_FOR_PREVIOUS_STRUCTURE;\n");                   \
        ((0x1100000000000000L) | ((uint64_t)(0b111111) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(2) << 16)                    \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_STOP_ENABLED_FOR_DPU_FRAME(dpu_id)                                              \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_STOP_ENABLED_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);       \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8)                                               \
            | ((uint64_t)(((((139582679023616l | (((((uint64_t)0) >> 0) & 15) << 24) | (((((uint64_t)0) >> 0) & 65535) << 0)))   \
                               >> (((2) << 3)))                                                                                  \
                   & 0xFFl))                                                                                                     \
...
#define CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_STOP_ENABLED_FOR_PREVIOUS_FRAME                                                 \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_STOP_ENABLED_FOR_PREVIOUS_FRAME;\n");                       \
        ((0x3300000000000000L)                                                                                                   \
            | ((uint64_t)(((((139582679023616l | (((((uint64_t)0) >> 0) & 15) << 24) | (((((uint64_t)0) >> 0) & 65535) << 0)))   \
                               >> (((2) << 3)))                                                                                  \
                   & 0xFFl))                                                                                                     \
...
#define CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_CLEAR_FOR_DPU_STRUCTURE                                                         \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_CLEAR_FOR_DPU_STRUCTURE;\n");                               \
        ((0x1100000000000000L) | ((uint64_t)(0b10) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16)                        \
            | ((uint64_t)(0) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                            \
    })
#define CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_CLEAR_FOR_PREVIOUS_STRUCTURE                                                    \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_CLEAR_FOR_PREVIOUS_STRUCTURE;\n");                          \
        ((0x1100000000000000L) | ((uint64_t)(0b0) << 0) | ((uint64_t)(0b0) << 8) | ((uint64_t)(0) << 16) | ((uint64_t)(0) << 24) \
            | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40));                                                                    \
    })
#define CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_CLEAR_FOR_DPU_FRAME(dpu_id)                                                     \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_CLEAR_FOR_DPU_FRAME(dpu_id = %u);\n", dpu_id);              \
        ((0x3300000000000000L) | ((uint64_t)(10) << 0) | ((uint64_t)(dpu_id) << 8) | ((uint64_t)(156) << 16)                     \
            | ((uint64_t)(2) << 24) | ((uint64_t)(0) << 32) | ((uint64_t)(0) << 40) | ((uint64_t)(0) << 48));                    \
    })
#define CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_CLEAR_FOR_PREVIOUS_FRAME                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DEBUG_STD_REPLACE_CLEAR_FOR_PREVIOUS_FRAME;\n");                              \
...
#define CI_FRAME_DPU_OPERATION_DEBUG_STD_SAMPLE_PC_FOR_PREVIOUS_STRUCTURE                                                        \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DEBUG_STD_SAMPLE_PC_FOR_PREVIOUS_STRUCTURE;\n");                              \
...
#define CI_FRAME_DPU_OPERATION_DEBUG_STD_SAMPLE_PC_FOR_PREVIOUS_FRAME                                                            \
    ({                                                                                                                           \
        LOGV(__vc(), "ptr = CI_FRAME_DPU_OPERATION_DEBUG_STD_SAMPLE_PC_FOR_PREVIOUS_FRAME;\n");                                  \
