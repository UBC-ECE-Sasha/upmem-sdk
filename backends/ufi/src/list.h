...
/* Shamelessly copied and arranged from linux kernel */
...
#define WRITE_ONCE(src, dest) ((src) = (dest))
...
#define list_for_each_entry_safe(pos, n, head, member)                                                                           \
    for (pos = list_first_entry(head, __typeof__(*pos), member), n = list_next_entry(pos, member); &pos->member != (head);       \
...
#define list_for_each_entry_safe_reverse(pos, n, head, member)                                                                   \
    for (pos = list_last_entry(head, __typeof__(*pos), member), n = list_prev_entry(pos, member); &pos->member != (head);        \
 ...
 * @member:	the name of the hlist_node within the struct.
 */
#define hlist_for_each_entry_from(pos, member) for (; pos; pos = hlist_entry_safe((pos)->member.next, __typeof__(*(pos)), member))
