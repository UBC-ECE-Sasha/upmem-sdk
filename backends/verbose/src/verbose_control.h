...
#define LOGW_ENABLED(vcs) ((vcs)->printw != NULL)
#define LOGI_ENABLED(vcs) ((vcs)->printi != NULL)
#define LOGD_ENABLED(vcs) ((vcs)->printd != NULL)
#define LOGV_ENABLED(vcs) ((vcs)->printv != NULL)
