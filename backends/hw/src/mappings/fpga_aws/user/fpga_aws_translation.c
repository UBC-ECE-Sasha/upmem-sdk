...
fpga_aws_write_to_rank(__attribute__((unused)) struct dpu_region_address_translation *tr,
    ...
    __attribute__((unused)) struct dpu_transfer_mram *xfer_matrix)
{
}
...
int
fpga_aws_init_region(__attribute__((unused)) struct dpu_region_address_translation *tr)
{
    return 0;
}

void
fpga_aws_destroy_region(__attribute__((unused)) struct dpu_region_address_translation *tr)
{
}
...
int
fpga_aws_init_rank(__attribute__((unused)) struct dpu_region_address_translation *tr,
    __attribute__((unused)) uint8_t channel_id,
    __attribute__((unused)) uint8_t rank_id)
{
    return 0;
